...
int main()
{
    ...
    cout << "Algoritmo gerador de tabela hash (com tratamento de colisão em lista encadeada)!\n";
    cout << "Digite a quantidade máxima de indíces da tabela: ";
    cin >> capacidade_max;

    TabelaHash tabela_individuos(capacidade_max);
